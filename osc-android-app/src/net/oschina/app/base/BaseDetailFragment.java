    ...
    public void handleShare() {
        ...
        dialog.setOnPlatformClickListener(new OnSharePlatformClick() {
            ...
            public void onPlatformClick(int id) {
                switch (id) {
                case R.id.ly_share_weichat_circle: //微信朋友圈
                    shareToWeiChatCircle();
                    break;
                case R.id.ly_share_weichat:   //微信
                    shareToWeiChat();
                    break;
                case R.id.ly_share_sina_weibo:   //微博
                    shareToSinaWeibo();
                    break;
                case R.id.ly_share_qq:  //   qq
                    shareToQQ(SHARE_MEDIA.QQ);
                    break;
                case R.id.ly_share_copy_link:  //复制链接
                    TDevice.copyTextToBoard(getShareUrl());
                    break;
                case R.id.ly_share_more_option:  //更多
