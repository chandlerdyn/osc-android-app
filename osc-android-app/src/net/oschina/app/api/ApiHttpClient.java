...
/**
 * 封装 AsyncHttpClient 类get、post、delete、put方法，使app中只有一个AsyncHttpClient实例。
 * <p> 业务无关层
 * @author WangLuJie
 *
 */
public class ApiHttpClient {
    ...
    /**
     * 封装的AsyncHttpClient的get方法、
     * @param partUrl
     * @param handler  请求完毕回调
     */
    ...
    /**
     * 初始化client，在自定义的application：AppContext中调用，全局只调用一次
     * @param c
     */
